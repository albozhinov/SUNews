    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteAuthorsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FollowersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorUser", x => new { x.FavoriteAuthorsId, x.FollowersId });
                    table.ForeignKey(
                        name: "FK_AuthorUser_AspNetUsers_FollowersId",
                        column: x => x.FollowersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorUser_Authors_FavoriteAuthorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleCategories", x => new { x.CategoryId, x.ArticleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorUser_FollowersId",
                table: "AuthorUser",
                column: "FollowersId");
